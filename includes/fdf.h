...
/*   Updated: 2014/12/30 17:48:42 by hhismans         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_drawline_img(void *img_ptr, t_point p1, t_point p2, \
		int color);
void				ft_drawline_img_c(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				ft_drawline_img_c_1(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				ft_drawline_img_c_2(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				ft_drawline_img_c_3(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				case_horiz(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				case_horizneg(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				case_verti(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
void				case_vertineg(void *img_ptr, t_point p1, t_point p2, \
		t_color c);
